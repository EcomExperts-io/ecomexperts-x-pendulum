...
${errorInfo.componentStack}`);
  ...
  // extensions/subscription-product-consent/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const handleChange = (value) => __async(this, null, function* () {
      ...
      if (value) {
        try {
          let fecha = new Date(
            (/* @__PURE__ */ new Date()).toLocaleString("en", { timeZone: "America/Los_Angeles" })
          );
          let formattedFecha = fecha.toString().split("GMT")[0];
          const result = yield noteChange({
            type: "updateNote",
    ...
    return isSubscription ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      Checkbox2,
      {
