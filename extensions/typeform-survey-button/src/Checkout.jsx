...
function Extension() {
  ...
  const [hasNutritionDefault, setHasNutritionDefault] = useState(0);
  const [hasNutritionPremium, setHasNutritionPremium] = useState(0);
  const [hasNutritionJennifer, setHasNutritionJennifer] = useState(0);
  const [hasNutritionTara, setHasNutritionTara] = useState(0);
