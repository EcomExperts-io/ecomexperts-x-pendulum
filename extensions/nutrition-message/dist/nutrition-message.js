...
${errorInfo.componentStack}`);
  ...
  // extensions/nutrition-message/src/Checkout.jsx
  ...
  function Extension() {
    ...
    const [hasPGC, setHasPGC] = (0, import_react12.useState)(false);
    const [hasNutrition, setHasNutrition] = (0, import_react12.useState)(false);
    ...
    return hasPGC && hasNutrition ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "bold", children: "You'll be getting an additional email shortly with a link to schedule your initial nutrition counseling session!" }),
